...
# pkg dependencies
sudo apt-get -y update && sudo apt-get -y install rsync wget gcc-mingw-w64-x86-64 g++-mingw-w64-x86-64 gcc-mingw-w64-i686 g++-mingw-w64-i686 
...
mkdir SDL2
mv SDL2-${SDL2_VERSION}/x86_64-w64-mingw32 SDL2/x86_64
mv SDL2-${SDL2_VERSION}/i686-w64-mingw32 SDL2/i686
rsync -r SDL2_image-${SDL2_IMAGE_VERSION}/x86_64-w64-mingw32/ SDL2/x86_64/.
rsync -r SDL2_image-${SDL2_IMAGE_VERSION}/i686-w64-mingw32/ SDL2/i686/.
